...
const signalEngine = require("./backend/engine/signal-engine");

const analyzeSignal =
  typeof signalEngine === "function"
    ? signalEngine
    : signalEngine.analyzeSignal;

if (typeof analyzeSignal !== "function") {
  throw new Error(
    "Signal engine failed to load: analyzeSignal export is missing."
  );
}
